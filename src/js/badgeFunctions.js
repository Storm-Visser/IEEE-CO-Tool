...
// Adds the little lable text on the board view 
...
// Check if a card deadline is updated, and if it is, update the relative due date for it and the children
// Also ensures a card in our database matches the card on the trello board when it is changed
